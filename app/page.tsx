            ...
            <Card className="text-center">
              ...
              <CardContent>
                <p className="text-gray-600">
                  ...
                  itself within 3-5 years and provides free energy for decades.
                </p>
              </CardContent>
            </Card>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                Our experts will visit your location, assess your energy needs,
                and provide a detailed quotation with no hidden costs. The
                survey is completely free with no obligations.
              </p>
          ...
          <div className="max-w-3xl mx-auto">
            <Accordion type="single" collapsible>
              ...
              <AccordionItem value="item-2">
                ...
                <AccordionContent>
                  Rooftop systems can be installed on residential and commercial
                  buildings, housing societies, and more.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-4">
                ...
                <AccordionContent>
                  ...
                  metering applications with the electricity department. We also
                  assist with subsidy applications and ensure compliance with
              ...
              <AccordionItem value="item-6">
                ...
                <AccordionContent>
                  Solar systems require minimal maintenance. We recommend annual
                  professional cleaning and inspection. Our maintenance packages
                  include regular cleaning, performance monitoring, and
        ...
        <footer className="bg-gray-900 text-white py-16">
          <div className="container mx-auto px-4">
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div>
                ...
                <p className="text-gray-400 mb-4">
                  Leading solar energy company providing complete solutions from
                  design to maintenance. Powering a sustainable future with
                  clean energy.
                </p>
            ...
            <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
              <p>
                &copy; 2025 SolarTech Solutions. All rights reserved. | Powering
                a sustainable future with clean energy.
              </p>
            </div>
          </div>
        </footer>
